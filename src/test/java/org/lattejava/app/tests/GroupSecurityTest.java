 ...
 * detail route, which is gated only by the base membership check): active member (200), pending member (200 —
 * invitees can view the group), missing group / non-member (303 → {@code /app/}). Role cases (use the owner-only
