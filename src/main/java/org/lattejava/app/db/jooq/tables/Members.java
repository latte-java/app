...
import org.lattejava.app.db.jooq.Indexes;
...
public class Members extends TableImpl<MembersRecord> {
    ...
    /**
     * The column <code>public.members.group_name</code>.
     */
    public final TableField<MembersRecord, String> GROUP_NAME = createField(DSL.name("group_name"), SQLDataType.CLOB.nullable(false), this, "");
     ...
     */
    public final TableField<MembersRecord, Role> ROLE = createField(DSL.name("role"), SQLDataType.CLOB.nullable(false), this, "", Converter.ofNullable(String.class, Role.class, t -> t == null ? null : org.lattejava.app.model.Role.valueOf(t), u -> u == null ? null : u.name()));

    /**
     * The column <code>public.members.state</code>.
     */
    public final TableField<MembersRecord, MembershipState> STATE = createField(DSL.name("state"), SQLDataType.CLOB.nullable(false), this, "", Converter.ofNullable(String.class, MembershipState.class, t -> t == null ? null : org.lattejava.app.model.MembershipState.valueOf(t), u -> u == null ? null : u.name()));
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.MEMBERS_USER_ID_IDX);
    }
    ...
    public List<ForeignKey<MembersRecord, ?>> getReferences() {
        return Arrays.asList(Keys.MEMBERS__MEMBERS_GROUP_NAME_FKEY);
    }
    ...
    public GroupsPath groups() {
        if (_groups == null)
            _groups = new GroupsPath(this, Keys.MEMBERS__MEMBERS_GROUP_NAME_FKEY, null);
    ...
    public List<Check<MembersRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("members_role_check"), "((role = ANY (ARRAY['OWNER'::text, 'CONTRIBUTOR'::text])))", true),
            Internal.createCheck(this, DSL.name("members_state_check"), "((state = ANY (ARRAY['PENDING'::text, 'ACTIVE'::text])))", true)
        );
    }
